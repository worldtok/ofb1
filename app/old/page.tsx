            ...
            <div className='self-center'>
              <span className='relative inline-block w-16'>
                <Image
                  ...
                  data-nimg='1'
                  decoding='async'
                  className='object-cover w-16 h-16 rounded-full shadow text-transparent'
                  loading='lazy'
                  quality={100}
                />
                <span className='absolute top-0 right-0 flex w-3 h-3 -ml-2'>
                  <span className='absolute inline-flex w-full h-full duration-150 bg-green-400 rounded-full opacity-75 animate-ping'></span>
              ...
              <p className='text-gray-500 text-md sm:text-lg'>
                ...
                <span>
                  ...
                  <Image
                    ...
                    decoding='async'
                    data-nimg='1'
                    className='inline-block h-3 text-transparent'
                    loading='lazy'
                  />
                  ,{' '}
                </span>
                <span>
                  ...
                  <Image
                    ...
                    decoding='async'
                    data-nimg='1'
                    className='inline-block h-4 text-transparent '
                    loading='lazy'
                  />
                </span>
                <span>
